<%-- Document : checkout Created on : Jul 8, 2024, 4:10:54 PM Author : admin
    ...
    <body style="">
                          ...
                          <tr class="product">
                            ...
                            <td class="product-description">
                              <span
                                ><input
                                  type="hidden"
                                  name="selected-category-uid"
                                  value="${requestScope.selectedCategory.categoryUID}"
                              /></span>
                              <span
                                >${requestScope.selectedCategory.title}</span
                              >
                            </td>
                            <td class="product-quantity">
                              ...
                              <input
                                ...
                                name="car-count"
                                min="1"
                                max="${requestScope.selectedCategory.carCount}"
                                value="1"
                              />
                            </td>
                            <td class="product-price">
                              <span class="order-summary-emphasis"
                                >${requestScope.selectedCategory.unitPrice}₫</span
                              >
                              <input
                                type="hidden"
                                name="total-amount"
                        ...
                        <tfoot class="total-line-table-footer">
                          <tr class="total-line">
                            <td class="total-line-name payment-due-label">
                              <span class="payment-due-label-total"
                                >Tổng cộng</span
                              >
                            </td>
                            <td class="total-line-name payment-due">
                              <span class="payment-due-currency">VND</span>
                              <span class="payment-due-price"> </span>
                              <span
                          ...
                          <div class="radio-wrapper content-box-row">
                            <label class="radio-label" for="payment_method_id">
                              ...
                              <div class="radio-content-input">
                                <img class="main-img" src="assets/cod.svg" />
                                <div>
      ...
      <script>
        ...
        setInterval(function () {
          ...
          var carCount = parseInt(
            document.getElementsByName("car-count")[0].value
          );
          ...
          document.getElementsByName("total-amount")[0].value =
            paymentDuePrice.toFixed(0);
          document.getElementsByClassName("payment-due-price")[0].innerText =
            paymentDuePrice.toFixed(0).replace(/\B(?=(\d{3})+(?!\d))/g, ".") +
            "₫";
        }, 100);
      </script>
    </body>
